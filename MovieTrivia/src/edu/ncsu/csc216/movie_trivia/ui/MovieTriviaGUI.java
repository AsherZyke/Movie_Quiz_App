package edu.ncsu.csc216.movie_trivia.ui;
...
import edu.ncsu.csc216.movie_trivia.quiz.MovieTrivia;
import edu.ncsu.csc216.movie_trivia.quiz.TriviaMaster;
import edu.ncsu.csc216.movie_trivia.util.EmptyQuestionListException;
import edu.ncsu.csc216.question_library.QuestionException;

/**
 * Teaching Staff GUI for the MovieTrivia Project
 * @author Jo Perry, Sarah Heckman, Jason King
 *
 */
public class MovieTriviaGUI extends JFrame implements ActionListener {
	...
	private static final String WINDOW_TITLE = "Movie Trivia";
	...
	private TriviaMaster quizMaster;
	...
	/**
	 * Performs actions in the GUI to display to the user based
	 * on preceding events in the program.
	 * 
	 * @param event the event the user created
	 */
	...
	private MovieTriviaGUI(String questionFile) {
		...
		try {
			quizMaster = new MovieTrivia(questionFile);
	...
	public static void main(String[] args) {
		if (args.length == 0)
			new MovieTriviaGUI(null);
		else
			new MovieTriviaGUI(args[0]);
	}
}
